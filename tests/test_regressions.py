...
def test_succeeded_in_parent_didnt_run_in_current_failed_in_child_failed_in_grandchild(
    ...
    # setup
    p[i - 1].tasks = [Task.create(id="1", label="test-prova", result="passed")]
...
def test_succeeded_in_parent_didnt_run_in_current_failed_in_child_succeeded_in_grandchild(
    ...
    p[i + 1].backedoutby = p[i + 3].rev
    p[i + 2].tasks = [Task.create(id="1", label="test-prova", result="passed")]
...
def test_succeeded_in_parent_succeeded_in_current_failed_in_child_failed_in_grandchild(
    ...
    p[i - 2].tasks = [Task.create(id="1", label="test-prova", result="passed")]
    p[i].tasks = [Task.create(id="1", label="test-prova", result="passed")]
    p[i + 1].tasks = [
        Task.create(
            id="1",
            label="test-prova",
...
def test_failure_on_backout(create_pushes):
    ...
    p[i - 1].tasks = [Task.create(id="1", label="test-failure", result="passed")]
    p[i].backedoutby = p[i + 2].rev
    p[i + 1].tasks = []
    p[i + 1].backedoutby = p[i + 3].rev
    p[i + 2].tasks = [
...
def test_failure_on_bustage_fix(create_pushes):
    ...
    p[i - 1].tasks = [
        Task.create(id="1", label="test", result="passed"),
        Task.create(id="1", label="test_for_detecting_bustage_fix", result="passed"),
    ]
    p[i].tasks = [
        Task.create(
            id="1",
...
def test_failed_and_bustage_fixed(create_pushes):
    ...
    p[i - 1].tasks = [Task.create(id="1", label="test-prova1", result="passed")]
    p[i].tasks = [
        Task.create(
            id="1",
            label="test-prova1",
...
def test_failed_with_child_push_still_failing_fixing_same_bug(create_pushes):
    ...
    p[i - 1].tasks = [
        Task.create(id="1", label="test-failure", result="passed"),
        Task.create(
            id="2",
            label="test-passed",
            result="passed",
...
def test_child_failed_and_bustage_fixed(create_pushes):
    ...
    p[len(p) - 1].tasks = [Task.create(id="1", label="test-prova", result="passed")]
    p[len(p) - 1].bugs = {123}
...
def test_fixed_by_commit(monkeypatch, create_pushes):
    ...
    p[i - 1].tasks = [
        Task.create(id="1", label="test-failure-current", result="passed"),
        Task.create(id="1", label="test-failure-next", result="passed"),
    ]
    p[i].backedoutby = p[i + 2].rev
    p[i + 1].tasks = [
        Task.create(
...
def test_fixed_by_commit_another_push_possible_classification8(
    ...
    p[i + 4].tasks = [Task.create(id="1", label="test-failure", result="passed")]
    p[i + 4].bugs = p[i].bugs
...
def test_fixed_by_commit_another_push_possible_classification9(
    ...
    p[i - 1].tasks = [Task.create(id="1", label="test-failure", result="passed")]
    p[i].tasks = [Task.create(id="1", label="test-failure", result="passed")]
    p[i].backedoutby = "3rev2"
    p[i + 1].tasks = [
        Task.create(
            id="1",
...
def test_intermittent_without_classification_and_not_backedout(create_pushes):
    ...
    p[i - 1].tasks = [Task.create(id="1", label="test-intermittent", result="passed")]
    p[i].tasks = [
        Task.create(id="1", label="test-intermittent", result="passed"),
        Task.create(
            id="2",
...
def test_intermittent_fixed_by_commit(monkeypatch, create_pushes):
    ...
    p[i - 2].tasks = [Task.create(id="1", label="test-intermittent", result="passed")]
...
def test_try(
    ...
    p[i - 1].tasks = [
        Task.create(id="1", label="test-new", result="passed"),
        Task.create(id="1", label="test-preexisting", result="passed"),
    ]
    p[i].tasks = [
        Task.create(
            id="1",
